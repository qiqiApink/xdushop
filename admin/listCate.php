...
$pageSize = 2;
$sql = "select id,cName from xdushop_cate";
...
$sql = "select id,cName from xdushop_cate order by id limit {$offset},{$pageSize}";
$rows = fetchAll($link, $sql);
if(!$rows)
{
    alert('Sorry, there is no category. Please add it first', 'addCate.php');
    exit;
}
?>
